...
public class FavoriteImaegAdapter extends RecyclerView.Adapter<ImageAdapter.ImageViewHolder> {
    private Context context;
    private List<Bitmap> images;
    private List<String> imageNames;
    private boolean isDeleteVisible = false;
    private FavOnDeleteClickListener onDeleteClickListener;

    public FavoriteImaegAdapter(Context context, List<Bitmap> images, List<String> imageNames) {
    ...
    public ImageAdapter.ImageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.favorites_item_image_layout, parent, false);
    ...
    public interface FavOnDeleteClickListener {
    ...
    public static class FavoritesAdapter extends RecyclerView.ViewHolder {
        ImageView imageView;
        TextView textView;
        ImageView deleteButton;

        public FavoritesAdapter(@NonNull View itemView) {
            super(itemView);
